...
from src.research.research_params import AddParams
...
class Case:
    def __init__(self, name, selector: str, selector_mode: float, mutator: str, mutator_mode: float, result):
        ...
        self.research.add_individual(AddParams('bacteria', 10, 0.4, 0.6))
        self.result = result
...
def test_iterator_population_one(research_obj: Case) -> None:
    research_result = research_obj.research.research(2, research_obj.iter_params)
